...
In Hoofdstuk~\ref{ch:resultaten-ingebouwd-model} worden de resultaten besproken van het loslaten van een ingebouwd model van een Computer Vision API op beelden van het Huis van Alijn, zoals vakantiekiekjes, trotse ouders met hun pasgeboren baby, huwelijksfoto's, kinderen op de foto met Sinterklaas en kinderen die poseren met hun speelgoed.

Vervolgens gaan we een stap verder en zullen we zelf een model maken dat losgelaten zal worden op diezelfde beelden van Huis van Alijn. In Hoofdstuk~\ref{ch:resultaten-custom-model} worden de resultaten hiervan geanalyseerd.
