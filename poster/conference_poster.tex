...
\captionof{figure}{\color{HoGentAccent5} Kan Clarifai gebruikt worden voor het beschrijven van historische foto's}
\end{center}\vspace{1cm}

\begin{center}\vspace{1cm}
	\includegraphics[width=1.0\linewidth]{performantie_themamodel}
	\captionof{figure}{\color{HoGentAccent5} Performantie van het model om historische foto's te classificeren volgens thema}
\end{center}\vspace{1cm}
