...
% interessant voor het toevoegen van inhoudelijke informatie
% velden waarop het goed zou scoren
% afhankelijk van hoe specifiek je het resultaat wil, hoe meer training er nodig is
% kan ook informatie geven over een object die niet past binnen de minimale registratie 
% of basisregistratie, maar die wel informatie geeft die voor bezoekers interessant is en die voor hen inhoudelijke informatie geeft.
% denk aan sfeer, kleur, gevoel, etc.
